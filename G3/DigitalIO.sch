...
U 1 1 59C42024
P 3600 1200
F 0 "#PWR01404" H 3600 950 50  0001 C CNN
...
U 1 1 59C5AF84
P 4250 3850
F 0 "#PWR01414" H 4250 3600 50  0001 C CNN
...
U 1 1 59C5B1A8
P 4250 3750
F 0 "#PWR01413" H 4250 3500 50  0001 C CNN
...
U 1 1 59C5B287
P 4250 3650
F 0 "#PWR01412" H 4250 3400 50  0001 C CNN
...
U 1 1 5A53D1F2
P 3600 900
F 0 "#PWR01403" H 3600 750 50  0001 C CNN
...
U 1 1 5B63AFA2
P 9850 3000
F 0 "#PWR01415" H 9850 2850 50  0001 C CNN
...
AR Path="/5B62EDB8/5B8AAF47" Ref="R1401"  Part="1" 
F 0 "R1401" V 10193 4150 50  0000 C CNN
...
$EndComp
$Comp
L power:+3.3V #PWR01416
U 1 1 5B8B47B5
P 10550 4150
F 0 "#PWR01416" H 10550 4000 50  0001 C CNN
...
U 1 1 5B9F8E58
P 3650 7000
F 0 "U1401" H 3650 7750 50  0000 C CNN
F 1 "MCP23017" H 3700 8050 50  0000 C CNN
F 2 "Package_SO:SOIC-28W_7.5x17.9mm_P1.27mm" H 3700 6050 50  0001 L CNN
...
U 1 1 5B9F8E67
P 1650 5450
F 0 "C1401" H 1765 5496 50  0000 L CNN
...
U 1 1 5B9F8E6E
P 1650 5600
F 0 "#PWR01402" H 1650 5350 50  0001 C CNN
...
U 1 1 5B9F8E74
P 3650 6900
F 0 "#PWR01406" H 3650 6650 50  0001 C CNN
...
U 1 1 5B9F8E7F
P 4150 6700
F 0 "#PWR01411" H 4150 6450 50  0001 C CNN
...
U 1 1 5B9F8E85
P 4150 6600
F 0 "#PWR01410" H 4150 6350 50  0001 C CNN
...
I2C_SDA
NoConn ~ 4150 5500
Text Notes 4650 6850 2    60   ~ 0
Adress 0x21
Text Notes 2150 5800 1    60   ~ 0
Near MCP23017
Wire Notes Line
	1350 5900 2400 5900
Wire Notes Line
...
U 1 1 5B9F8E9B
P 3650 4900
F 0 "#PWR01405" H 3650 4750 50  0001 C CNN
F 1 "+3.3V" V 3650 5150 50  0000 C CNN
...
U 1 1 5B9F8EA1
P 1650 5300
F 0 "#PWR01401" H 1650 5150 50  0001 C CNN
F 1 "+3.3V" H 1650 5500 50  0000 C CNN
...
U 1 1 5BA100B7
P 4150 6500
F 0 "#PWR01409" H 4150 6350 50  0001 C CNN
